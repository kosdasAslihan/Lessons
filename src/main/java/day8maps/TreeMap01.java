...
public class TreeMap01 {
    ...
    public static void main(String[] args) {
        ...
        //tailMap() verilen key'den başlayarak sonra kadar tüm entry'leri size verir.
        ...
        //tailMap(String, false) verilen key'den başlayarak sonra kadar tüm entry'leri size verir ama sizin verdiğiniz hariç tutar
        ...
        //Başlangıç key'i "Kevin Bridgeman", dahil olsun mu = true, hangi key'de duralım = "Tom Hanks", Tom dahil olsun mu = false
        ...
        System.out.println(map7); //null - Tom Hanks'den sonra eleman yok
